...
import { load } from '../src/blockchainFunctions';
        ...
        <HStack w='full'>
          ...
          <VStack>
            ...
            <HStack w='md'>
              ...
              value={input}
              />
              <Button onClick={handleAddTask} bg='red.500'>ADD</Button>
            </HStack>
            <Box h='30px' />
            <Text>Todo</Text>
            {
              ...
              <HStack key={idx} w='md' bg='gray.100' borderRadius={7}>
                ...
                <Text>{task[1]}</Text>
                <Spacer />
                <Button bg='red.500' onClick={ () => handleToggled(task[0].toNumber()) }>DONE</Button>
              </HStack> : null
              )
            }
            <Box h='10px' />
            <Text>Tasks done</Text>
            {
              ...
              <HStack key={idx} w='md' bg='gray.100' borderRadius={7}>
                ...
                <Text>{task[1]}</Text>
                <Spacer />
                <Button bg='red.500' onClick={ () => handleToggled(task[0].toNumber() ) }>UNDONE</Button>
              </HStack> : null
              )
            }
          </VStack>
