...
const JoinBattle = () => {
  ...
  useEffect(() => {
    if(gameData?.activeBattles?.battleStatus === 1) navigate(`/battle/${gameData.activeBattles.name}`)
  },[gameData])
    ...
    <>
      ...
      <div className={styles.joinContainer}>
        {gameData.pendingBattles.length 
          ? gameData.pendingBattles.filter((battle) => !battle.players.includes(walletAddress) && battle.battleStatus !==1).map((battle, index) => (
