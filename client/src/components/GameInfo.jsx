...
const GameInfo = () => {
  ...
  const battleExit = async () => {
    const battleName = gameData.activeBattles?.name;
    ...
    try {
      ...
      setShowAlert({ status: true, type: 'info', message: `You are leaving ${battleName}`});
